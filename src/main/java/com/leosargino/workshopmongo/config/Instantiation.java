package com.leosargino.workshopmongo.config;

import com.leosargino.workshopmongo.domain.Post;
import com.leosargino.workshopmongo.domain.User;
import com.leosargino.workshopmongo.dto.AuthorDTO;
import com.leosargino.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post2 = new Post(null,sdf.parse("25/03/2018"),"Acabou viagem", "Voltando de São Paulo",new AuthorDTO(maria));
        ...
        CommentDTO c3 = new CommentDTO("Good day", sdf.parse("22/03/2018"), new AuthorDTO(alex));
